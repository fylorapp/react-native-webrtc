...
std::vector<jsi::Value> convertNSArrayToStdVector(jsi::Runtime &runtime,
                                                  NSArray *value) {
...
NSString *convertJSIStringToNSString(jsi::Runtime &runtime,
...
NSArray *convertJSIArrayToNSArray(jsi::Runtime &runtime,
  ...
  for (size_t i = 0; i < size; i++) {
    ...
    [result addObject:convertJSIValueToObjCObject(
...
RCTResponseSenderBlock convertJSIFunctionToCallback(
    jsi::Runtime &runtime, const jsi::Function &value) {
